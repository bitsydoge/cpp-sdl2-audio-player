...
void texToRenderPart(SDL_Texture* tex, SDL_Renderer *render, int coef, int x, int y, int w, int h, int x2, int y2, int w2, int h2)
{
	//
	SDL_Rect rect = { 0 };
	SDL_Rect rect2 = { 0 };
	...
	rect2.x = x2; rect2.y = y2; rect2.h = h2; rect2.w = w2;

	SDL_RenderCopy(render, tex, &rect2, &rect);
}
